...
require_file "${RMR_BUILD_DIR}/host/shell-access.js"
require_file "${RMR_BUILD_DIR}/host/shell-router.js"
require_file "${RMR_BUILD_DIR}/host/shell-variant.js"
require_file "${RMR_BUILD_DIR}/host/styles-mobile.css"
